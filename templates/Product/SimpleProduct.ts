  ...
  setup() {
    ...
    const ProductVariation = defineAsyncComponent({
      loader: async () => {
        try {
          ...
          return await import(`/src/components/template_01/SimpleProduct/ProductVariation.vue`);
        } catch (error) {
          // If the specified template fails to load, fall back to SimpleProduct1.vue
          // return import(`/src/components/template_01/Product/${data.type}Product.vue`);
        }
      },
    });
    ...
    const Gallery = defineAsyncComponent({
      loader: async () => {
        try {
          // Attempt to dynamically import the specified template component
          return await import(`/src/components/template_01/Product/Gallery.vue`);
        } catch (error) {
          // If the specified template fails to load, fall back to SimpleProduct1.vue
          // return import(`/src/components/template_01/Product/${data.type}Product.vue`);
        }
    ...
    const AddToCard = defineAsyncComponent({
      loader: async () => {
        try {
          // Attempt to dynamically import the specified template component
          return await import(`/src/components/template_01/SimpleProduct/AddToCart.vue`);
        } catch (error) {
          // If the specified template fails to load, fall back to SimpleProduct1.vue
          // return import(`/src/components/template_01/Product/${data.type}Product.vue`);
        }
